...
export default function Header() {
  return (
    <header className="fixed top-0 w-full z-50 px-4 pt-3">
      <nav className="container-organic-md max-w-7xl mx-auto px-6 py-3.5 flex items-center justify-between bg-bg-surface/90 backdrop-blur-xl">
        ...
        <div className="flex gap-1 text-sm tracking-wide">
          <Link
            href="/"

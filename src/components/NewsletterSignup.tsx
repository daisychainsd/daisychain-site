            ...
            <>
              ...
              >
                ...
                <button
                  ...
                  className="px-6 py-3 rounded-full bg-blue-300 text-bg-deep text-sm font-semibold hover:bg-blue-200 transition-colors duration-200 disabled:opacity-50 shrink-0"
                >
